...
Pointer queue_front(Queue queue) {//θα μπρουσα και list_last (εγω διατρεχω την ουρα οπως θελω, ο χρηστης δεν γνωριζει τι γιντεται,απλα θα πρεπε να αλλαξω και το queue back σε list_first )
//OMΩΣ ΕΤΣΙ ΘΑ ΕΙΧΑ ΘΕΜΑ ΣΤΟ REMOVE.Γιατι για την remove next θα χρειαζομουν προσβαση στο προτελευταιο στοιχειο
...
//αν η λιστα ειναι κενη δουλευει γιατι η λιστ λαστ επιστρεφει list_eof 
